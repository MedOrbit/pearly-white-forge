          ...
          <div className="flex gap-4 w-max px-[calc((100vw-1280px)/2+1.25rem)] min-[1280px]:px-5">
            {showCases.map((c, i) => (
              <div
                ...
                className="w-[345px] xl:w-[385px] shrink-0 rounded-2xl bg-card p-2 shadow-sm ring-1 ring-black/[0.05] snap-center"
              >
                <div className="grid grid-cols-2 gap-1.5 h-[128px] xl:h-[142px]">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[0.88fr_1.12fr] gap-10 lg:gap-12 items-center relative">
          ...
          <div className="hidden lg:block animate-fade-up">
            <img
              ...
              width={1080}
              height={1600}
              className="w-full h-[600px] xl:h-[660px] object-contain object-center"
            />
          </div>
        </div>
