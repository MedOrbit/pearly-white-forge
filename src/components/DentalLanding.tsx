          ...
          <div className="flex gap-4 w-max px-[calc((100vw-1280px)/2+1.25rem)] min-[1280px]:px-5">
            {showCases.map((c, i) => (
              <div
                ...
                className="w-[330px] xl:w-[370px] shrink-0 rounded-2xl bg-card p-2 shadow-sm ring-1 ring-black/[0.05] snap-center"
              >
                <div className="grid grid-cols-2 gap-1.5 h-[120px] xl:h-[132px]">
...
export default function DentalLanding() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden pb-24 md:pb-0">
      ...
      {/* HERO */}
      <section className="relative px-5 sm:px-6 pt-2 lg:pt-2 pb-6 lg:pb-5">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[0.88fr_1.12fr] gap-10 lg:gap-12 items-center relative">
          <div className="animate-fade-up">
            ...
            <h1 className="font-display text-[2.75rem] sm:text-6xl lg:text-[4.2rem] xl:text-[4.6rem] font-medium leading-[1.02] tracking-tight text-balance mb-6 lg:mb-5">
