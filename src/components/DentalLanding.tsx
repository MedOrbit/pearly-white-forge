      ...
      <section className="relative px-5 sm:px-6 pt-10 lg:pt-2 pb-8 lg:pb-6 lg:min-h-[calc(100vh-4rem)] lg:flex lg:flex-col lg:justify-start lg:overflow-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-10 lg:items-start relative">
          <div className="animate-fade-up lg:flex lg:flex-col">
            {/* Reviews */}
            <div className="flex items-center gap-3 mb-6 lg:mb-5">
            ...
            <h1 className="font-display text-[2.75rem] sm:text-6xl lg:text-[3.25rem] font-medium leading-[1.02] lg:leading-[1.05] tracking-tight text-balance mb-6 lg:mb-5">
            ...
            <p className="text-base text-muted-foreground max-w-[52ch] mb-4 lg:mb-5 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-2 lg:gap-x-4 lg:gap-y-3">
              {[
